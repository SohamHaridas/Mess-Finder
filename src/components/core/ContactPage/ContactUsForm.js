...
import { contactusEndpoint } from "../../../services/operations/api"
    ...
    <form className = "flex flex-col gap-7" onSubmit = {handleSubmit(submitContactForm)} >
        ...
        <div className="flex flex-col gap-5 lg:flex-row">
          ...
          <div className="flex flex-col gap-2 lg:w-[48%]">
            <label htmlFor="firstname" className="lable-style"> First Name <sup className='text-pink-200'>*</sup> </label>
          ...
          <div className="flex flex-col gap-2 lg:w-[48%]">
            <label htmlFor="lastname" className="lable-style"> Last Name <sup className='text-pink-200'>*</sup> </label>
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="email" className="lable-style"> Email Address <sup className='text-pink-200'>*</sup> </label>
        ...
        <div className="flex flex-col gap-2">
            <label htmlFor="phonenumber" className="lable-style"> Phone Number <sup className='text-pink-200'>*</sup> </label>

            <div className="flex gap-5">

                <div className="flex w-[81px] flex-col gap-2">
                  <p className="mt-3 ml-3 ">+91</p>
                </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <label htmlFor="message" className="lable-style"> Message <sup className='text-pink-200'>*</sup> </label>
