        ...
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <label htmlFor="firstName" className="lable-style text-richblack-5">  First Name  </label>
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <label htmlFor="lastName" className="lable-style text-richblack-5"> Last Name </label>
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <label htmlFor="location" className="lable-style text-richblack-5"> Location </label>
              <select type="text"  name="location"  id="location" className="form-style" {...register("location", { required: true })}  defaultValue={user?.additionalDetails?.location} >
                {location.map((ele, i) => {return (<option key={i} value={ele}> {ele} </option> )})}
              </select>
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <label htmlFor="contactNumber" className="lable-style text-richblack-5">  Contact Number  </label>
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <label htmlFor="about" className="lable-style text-richblack-5"> About </label>
